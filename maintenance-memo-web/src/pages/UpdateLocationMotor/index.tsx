...
const RegisterMotor: React.FC = () => {
  ...
  const newNameLocalUnit = !!newMotor.localUnit ? locations[newMotor.localUnit - 1].unit : undefined;
  const newNameLocalArea = !!newMotor.localUnit ? locations[newMotor.localUnit - 1].area[newMotor.localArea - 1] : undefined;
